-- CLEAN RESET & SETUP SCRIPT
-- This will DROP existing tables and recreate them cleanly.
-- WARNING: This deletes any data in 'profiles', 'test_attempts', and 'ai_explanations'.
...
-- 5. RECREATE TEST_ATTEMPTS TABLE
...
-- 6. RECREATE AI_EXPLANATIONS CACHE TABLE
